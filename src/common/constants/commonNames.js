...
export const ARE_YOU_SURE_YOU_WANT_TO_DELETE_SERVICE="Are you sure you want to delete this service?"
...
export const PLEASE_SELECT_BOTH_START_END_DATE="Please select both start and end dates."
export const NO_DATA_AVAILABLE="No data available."
export const DATE_CREATED_AT = "Date (Created At)"
export const EVENT_REPORT="Event Report"
export const GENERATE_REPORT ="Generate Report"
export const REPORT_TYPE = "Report Type:"
export const BOOKING_REPORT = "Booking Report"
